...
module lab9_soc_mm_interconnect_0 (
	...
	wire  [104:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> reset_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // reset_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> reset_s1_agent:cp_channel
	...
	wire  [104:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [104:0] reset_s1_agent_rp_data;                                                             // reset_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [104:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_009:sink_data
	...
	wire          reset_s1_agent_rdata_fifo_src_valid;                                                // reset_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] reset_s1_agent_rdata_fifo_src_data;                                                 // reset_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          reset_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_005:in_0_ready -> reset_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> reset_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> reset_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                  // reset_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> reset_s1_agent:rdata_fifo_sink_error
