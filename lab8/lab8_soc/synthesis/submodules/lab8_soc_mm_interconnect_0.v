...
module lab8_soc_mm_interconnect_0 (
	...
	wire  [106:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> keycode_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // keycode_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [14:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> keycode_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> otg_hpi_address_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> otg_hpi_data_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> otg_hpi_r_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> otg_hpi_w_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> otg_hpi_cs_s1_agent:cp_channel
	...
	wire          cmd_mux_011_src_valid;                                                              // cmd_mux_011:src_valid -> reset_s1_agent:cp_valid
	wire  [106:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> reset_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                              // reset_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [14:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> reset_s1_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                                      // cmd_mux_011:src_startofpacket -> reset_s1_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                                        // cmd_mux_011:src_endofpacket -> reset_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_012_src_valid;                                                              // cmd_mux_012:src_valid -> accumulate_s1_agent:cp_valid
	wire  [106:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> accumulate_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                              // accumulate_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [14:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> accumulate_s1_agent:cp_channel
	wire          cmd_mux_012_src_startofpacket;                                                      // cmd_mux_012:src_startofpacket -> accumulate_s1_agent:cp_startofpacket
	wire          cmd_mux_012_src_endofpacket;                                                        // cmd_mux_012:src_endofpacket -> accumulate_s1_agent:cp_endofpacket
	...
	wire  [106:0] keycode_s1_agent_rp_data;                                                           // keycode_s1_agent:rp_data -> router_006:sink_data
	...
	wire          reset_s1_agent_rp_valid;                                                            // reset_s1_agent:rp_valid -> router_013:sink_valid
	wire  [106:0] reset_s1_agent_rp_data;                                                             // reset_s1_agent:rp_data -> router_013:sink_data
	wire          reset_s1_agent_rp_ready;                                                            // router_013:sink_ready -> reset_s1_agent:rp_ready
	wire          reset_s1_agent_rp_startofpacket;                                                    // reset_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          reset_s1_agent_rp_endofpacket;                                                      // reset_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire          accumulate_s1_agent_rp_valid;                                                       // accumulate_s1_agent:rp_valid -> router_014:sink_valid
	wire  [106:0] accumulate_s1_agent_rp_data;                                                        // accumulate_s1_agent:rp_data -> router_014:sink_data
	wire          accumulate_s1_agent_rp_ready;                                                       // router_014:sink_ready -> accumulate_s1_agent:rp_ready
	wire          accumulate_s1_agent_rp_startofpacket;                                               // accumulate_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          accumulate_s1_agent_rp_endofpacket;                                                 // accumulate_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire   [14:0] cmd_demux_001_src3_channel;                                                         // cmd_demux_001:src3_channel -> cmd_mux_011:sink1_channel
	...
	wire   [14:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> cmd_mux_012:sink1_channel
	...
	wire   [14:0] rsp_demux_011_src1_channel;                                                         // rsp_demux_011:src1_channel -> rsp_mux_001:sink3_channel
	...
	wire   [14:0] rsp_demux_012_src1_channel;                                                         // rsp_demux_012:src1_channel -> rsp_mux_001:sink4_channel
	...
	wire  [106:0] cmd_demux_src13_data;                                                               // cmd_demux:src13_data -> crosser:in_data
	...
	wire  [106:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_013:sink0_data
	...
	wire          crosser_001_out_valid;                                                              // crosser_001:out_valid -> cmd_mux_013:sink1_valid
	wire  [106:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_013:sink1_data
	wire          crosser_001_out_ready;                                                              // cmd_mux_013:sink1_ready -> crosser_001:out_ready
	wire   [14:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_013:sink1_channel
	wire          crosser_001_out_startofpacket;                                                      // crosser_001:out_startofpacket -> cmd_mux_013:sink1_startofpacket
	wire          crosser_001_out_endofpacket;                                                        // crosser_001:out_endofpacket -> cmd_mux_013:sink1_endofpacket
	wire          rsp_demux_013_src0_valid;                                                           // rsp_demux_013:src0_valid -> crosser_002:in_valid
	wire  [106:0] rsp_demux_013_src0_data;                                                            // rsp_demux_013:src0_data -> crosser_002:in_data
	...
	wire          crosser_002_out_valid;                                                              // crosser_002:out_valid -> rsp_mux:sink13_valid
	wire  [106:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink13_data
	wire          crosser_002_out_ready;                                                              // rsp_mux:sink13_ready -> crosser_002:out_ready
	wire   [14:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink13_channel
	wire          crosser_002_out_startofpacket;                                                      // crosser_002:out_startofpacket -> rsp_mux:sink13_startofpacket
	wire          crosser_002_out_endofpacket;                                                        // crosser_002:out_endofpacket -> rsp_mux:sink13_endofpacket
	wire          rsp_demux_013_src1_valid;                                                           // rsp_demux_013:src1_valid -> crosser_003:in_valid
	wire  [106:0] rsp_demux_013_src1_data;                                                            // rsp_demux_013:src1_data -> crosser_003:in_data
	wire          rsp_demux_013_src1_ready;                                                           // crosser_003:in_ready -> rsp_demux_013:src1_ready
	wire   [14:0] rsp_demux_013_src1_channel;                                                         // rsp_demux_013:src1_channel -> crosser_003:in_channel
	wire          rsp_demux_013_src1_startofpacket;                                                   // rsp_demux_013:src1_startofpacket -> crosser_003:in_startofpacket
	wire          rsp_demux_013_src1_endofpacket;                                                     // rsp_demux_013:src1_endofpacket -> crosser_003:in_endofpacket
	...
	wire          keycode_s1_agent_rdata_fifo_src_valid;                                              // keycode_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] keycode_s1_agent_rdata_fifo_src_data;                                               // keycode_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          keycode_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_004:in_0_ready -> keycode_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> keycode_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> keycode_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // keycode_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> keycode_s1_agent:rdata_fifo_sink_error
	...
	wire          reset_s1_agent_rdata_fifo_src_valid;                                                // reset_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] reset_s1_agent_rdata_fifo_src_data;                                                 // reset_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire          reset_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_011:in_0_ready -> reset_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_011_out_0_valid;                                                  // avalon_st_adapter_011:out_0_valid -> reset_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                                   // avalon_st_adapter_011:out_0_data -> reset_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                                  // reset_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                                  // avalon_st_adapter_011:out_0_error -> reset_s1_agent:rdata_fifo_sink_error
	wire          accumulate_s1_agent_rdata_fifo_src_valid;                                           // accumulate_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire   [33:0] accumulate_s1_agent_rdata_fifo_src_data;                                            // accumulate_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire          accumulate_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_012:in_0_ready -> accumulate_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_012_out_0_valid;                                                  // avalon_st_adapter_012:out_0_valid -> accumulate_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_012_out_0_data;                                                   // avalon_st_adapter_012:out_0_data -> accumulate_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_012_out_0_ready;                                                  // accumulate_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire    [0:0] avalon_st_adapter_012_out_0_error;                                                  // avalon_st_adapter_012:out_0_error -> accumulate_s1_agent:rdata_fifo_sink_error
	wire          sdram_s1_agent_rdata_fifo_out_valid;                                                // sdram_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] sdram_s1_agent_rdata_fifo_out_data;                                                 // sdram_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_013:in_0_data
	...
	lab8_soc_mm_interconnect_0_rsp_mux rsp_mux (
		...
		.sink13_ready         (crosser_002_out_ready),                          //    sink13.ready
		.sink13_valid         (crosser_002_out_valid),                          //          .valid
		.sink13_channel       (crosser_002_out_channel),                        //          .channel
		.sink13_data          (crosser_002_out_data),                           //          .data
		.sink13_startofpacket (crosser_002_out_startofpacket),                  //          .startofpacket
		.sink13_endofpacket   (crosser_002_out_endofpacket),                    //          .endofpacket
